...
**Where it lives:** as of 2026-07-04, no dedicated storage exists for this — captured summaries live wherever the underlying artifact already lives (e.g. a commit message, an ADR's Context section, [`Current-State.md`](../architecture/Current-State.md)'s "Bugs found and fixed" notes).
