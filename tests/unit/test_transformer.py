...
def test_vmm_domains_aggregated_across_locations():
    locations = [
        _location("site-a", aci_fabric_policies={"vmm_domains": [{"name": "vmm-a"}]}),
        _location("site-b", aci_fabric_policies={"vmm_domains": [{"name": "vmm-b"}]}),
    ]
...
def test_access_bindings_and_l3out_protocol_intent_are_preserved():
    ...
    vlans = [
        {
            ...
            "_custom_field_data": {
                "aci_application_profile": "web-ap",
                "aci_epg_bridge_domain": "web-bd",
                "aci_physical_domains": ["ExtL3Dom"],
                "aci_vmm_domains": [{"name": "vcenter", "encap": "vlan-200", "mode": "regular"}],
    ...
    assert epg["physical_domains"] == ["ExtL3Dom"]
    assert epg["vmm_domains"][0]["name"] == "vcenter"
